...
export const believerNftAbi = [
  ...
  },
  {
    ...
    outputs: [
      {
        name: 'info',
        internalType: 'struct BelieverNFT.BelieverNFTInfo',
        type: 'tuple',
        components: [
...
export const bountyAbi = [
  ...
  },
  {
    ...
    outputs: [
      {
        name: '',
        internalType: 'struct Bounty.Request',
        type: 'tuple',
        components: [
          { name: 'recipient', internalType: 'address', type: 'address' },
          { name: 'bountyId', internalType: 'string', type: 'string' },
        ],
      },
    ],
    stateMutability: 'view',
...
export const bountyFacetAbi = [
  {
    type: 'constructor',
    inputs: [{ name: '_ink', internalType: 'contract INK', type: 'address' }],
    stateMutability: 'nonpayable',
  },
  {
    type: 'error',
  ...
  },
  {
    ...
    name: 'ClaimBountyFilledEvent',
  },
  { type: 'fallback', stateMutability: 'payable' },
  {
    type: 'function',
    inputs: [{ name: 'bountyId', internalType: 'string', type: 'string' }],
    name: 'createClaimBountyRequest',
    outputs: [{ name: '', internalType: 'uint256', type: 'uint256' }],
    stateMutability: 'payable',
  },
  {
    ...
    inputs: [
      ...
      {
        name: 'rewards',
        internalType: 'struct BountyFacet.RewardParam[]',
        type: 'tuple[]',
        components: [
...
export const iVaultAbi = [
  {
    ...
    inputs: [],
    name: 'getDaoVault',
    outputs: [{ name: '', internalType: 'contract DaoVault', type: 'address' }],
    stateMutability: 'view',
  },
  {
    type: 'function',
    inputs: [],
    name: 'getDaoVaultAddress',
    outputs: [{ name: '', internalType: 'address', type: 'address' }],
    stateMutability: 'view',
  },
] as const
